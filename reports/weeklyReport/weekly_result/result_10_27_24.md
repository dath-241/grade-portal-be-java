...
## Meeting Minutes Result - [27/10/2024]
...
- Các issue đã được triển khai cho các thành viên trong nhóm Assign vào, việc này sẽ đảm bảo kết quả hiện thực dữ án sẽ được mô tả đầy đủ trong Repo.
  ![alt text](/reports/weeklyReport/weekly_result/img_10_27_24/issue.png)
- Các thành viên trong nhóm đều đã đảm bảo chạy được dự án ở Local bởi PO, các Pull Request đã bắt đầu được update vào nhánh Staging để hoàn thiện các Feature được mô tả trong issue.
  ![alt text](/reports/weeklyReport/weekly_result/img_10_27_24/PullRequest.png)
