...
public class UserService extends DefaultOAuth2UserService {
	...
	public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
		...
		if (admin != null)
			attributes.put("adminId", admin.getId());
		if (teacher != null)
			attributes.put("teacherId", teacher.getId());
		if (student != null)
			attributes.put("studentId", student.getId());
	...
	// Giúp chuyển từ định dạng tên của google sang định dạng tên dùng trong hệ
	// thống
